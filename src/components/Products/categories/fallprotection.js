        ...
        <Container>
          ...
          <Grid stackable columns={3}>
            ...
            >
              ...
              <div className="product-content-heading">Spiderking Full Body Harness with Back Support </div>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Full Body Harness 4D-Ring</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty, High Quality </li>
                  <li> Webbing: 45mm </li>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Full Body Harness 1 D-Ring</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty, High Quality </li>
                  <li> Webbing: 45mm </li>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Double Lanyard with Shock Absorber</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty, High Quality </li>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Single Lanyard with Shock Absorber</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty, High Quality </li>
                  <li> Gentle tear energy absorbing design  </li>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Single Lanyard Rope Type</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty, High Quality </li>
                  <li> Polyester rope with sewn terminations and protective thimbles</li>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Lifeline 25 Meters</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty </li>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Safety Belt w/ Rope and Big Hook</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty, easy to use  </li>
                  <li> Webbing: 45mm </li>
                  <li> 1 D-ring for positioning </li>
                  <li> Polyester rope with sewn terminations and protective thimbles with 1 big hook  </li>
                  <li> Maximum length: 2m </li>
                  <li> CE  EN 354 Compliant </li>
                </ul>
              </div>
            ...
            >
              <Image src={logo} size="small" className="product-image" />
              <div className="product-content-heading">Spiderking Rope Grab - Wing Type</div>
              <div className="product-desc">
                <ul>
                  <li> Heavy duty </li>
